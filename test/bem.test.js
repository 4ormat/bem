...
test("bem - creates correct BEM classes", () => {
  const BEM = bem("alert");
...
test("bem - allows for array modifiers", () => {
  const BEM = bem("alert")
    .e("text")
...
test("bem - allows for object modifiers", () => {
  let BEM;
...
test("bem - renders classes for partial curry", () => {
  const Dummy = () => (
...
test("bem.toSelector", () => {
  ...
  const modifiedModifiedBlockElement = modifiedBlockElement.modifier("success");
